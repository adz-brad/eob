        ...
        <>
            ...
            <div className="flex flex-col md:flex-row md:items-center">
                <div className="flex flex-col md:w-3/5 md:p-4 mx-8">
                    <h1 className="mt-2 mb-4">Acne Treatment</h1>
                    <p className="my-1">
                ...
                <StaticImage 
                    ...
                    className="max-h-[400px] rounded-lg shadow-lg my-8 md:mx-auto"
                />
            </div>
            <div className="flex flex-col lg:flex-row p-4 lg:p-8 md:mx-auto md:my-8">
            <Card cardBodyClass="p-4" cardWrapperClass="lg:w-2/5 lg:mx-4">
                        <div className="md:m-2">
                        <h1 className="my-4 md:mt-2 mb-4 md:mb-8 pb-2 border-b-2 border-green">How It Works</h1>
                        <p className="my-1">
                        ...
                        <div className="md:m-2 p-4 lg:px-8 lg:w-3/5 lg:mx-8">
