    ...
    return (
        <>
            ...
            <Banner
                ...
                image={<StaticImage alt="Essence of Beauty Ottawa - Virtual Acne Program" src="../assets/images/virtualAcneHeader.png" />}
                noFade
            />
            <section className="flex flex-col md:flex-row md:items-center p-4 md:p-8 my-8" aria-labelledby="virtual-acne-heading">
                <div className="flex flex-col md:w-1/2 mx-auto">
                    <h1 id="virtual-acne-heading" className="text-2xl md:text-4xl font-bold mb-2">Treat Your Acne With Amazing Results, Virtually!</h1>
            ...
            <section className="flex flex-col p-4 md:p-8" aria-labelledby="more-than-products-heading">
                ...
                <div className="p-4 lg:p-8 flex flex-col items-center">
                    ...
                    <Gallery
                        ...
                        images={[
                            <StaticImage src="../assets/images/holisticAcne1.jpg" alt="Virtual Acne Program Before & After Treatment Image" />,
                            <StaticImage src="../assets/images/holisticAcne4.jpg" alt="Virtual Acne Program Before & After Treatment Image" />,
                            <StaticImage src="../assets/images/holisticAcne6.jpg" alt="Virtual Acne Program Before & After Treatment Image" />
                        ]}
                    />

                </div>
            </section>
            <section id="virtual-acne-program-faq" className="p-4 lg:p-8 flex flex-col items-center lg:m-8" aria-labelledby="faq-heading">
    ...
    return (
        <>
            <Seo
                ...
                pageImage="https://www.essenceofbeauty.ca/images/benefits.jpg"
                additionalSchema={faqPageSchema}
            />
