    ...
    return(
        <>
            ...
            <div className="">
                <div className="flex flex-col md:flex-row md:items-center">
                    <div className="flex flex-col md:w-1/2 lg:mx-auto md:mr-8 p-4 md:p-8 lg:px-16">
                        <h1 className="my-2 font-semibold">Holistically Heal Your Skin!</h1>
            ...
            <div className="bg-lightGreen rounded-lg shadow-lg flex flex-col lg:flex-row lg:py-8">
                <div id="holistic-acne-different-approach" className="flex flex-col lg:w-1/2 p-4 md:p-8 lg:px-16">
                ...
                <div className="flex flex-col lg:w-1/3 p-4 md:p-8 lg:mx-auto">
                <BeforeAfter
                    className="rounded-sm shadow-lg h-[400px]"
                    beforeImage={<StaticImage src="../assets/images/holisticAcneBefore1.png" alt="Holistic Acne Program Before Treatment Image" />}
                    afterImage={<StaticImage src="../assets/images/holisticAcneAfter1.png" alt="Holistic Acne Program After Treatment Image" />}
                />
                <span className="text-center mt-4 text-sm">Slide to compare before and after holistic acne treatment</span>
                </div>
            </div>
            <div className="flex md:m-8 flex-col md:flex-row my-4">
                <div className="flex flex-col md:w-1/2 p-4 lg:p-8">
                ...
                <div className="flex flex-col lg:p-8">
                    <div className="flex flex-col lg:flex-row my-auto">           
                        <BeforeAfter
                            className="rounded-sm shadow-lg h-[400px] my-2 lg:my-0 mx-2"
                            beforeImage={<StaticImage src="../assets/images/holisticAcneBefore2.png" alt="Holistic Acne Program Before Treatment Image" />}
                            afterImage={<StaticImage src="../assets/images/holisticAcneAfter2.png" alt="Holistic Acne Program After Treatment Image" />}
                        />
                        <BeforeAfter
                            className="rounded-sm shadow-lg h-[400px] my-2 lg:my-0 mx-2"
                            beforeImage={<StaticImage src="../assets/images/holisticAcneBefore3.png" alt="Holistic Acne Program Before Treatment Image" />}
                            afterImage={<StaticImage src="../assets/images/holisticAcneAfter3.png" alt="Holistic Acne Program After Treatment Image" />}
                        />
                    </div>
                    <span className="text-center text-sm lg:-mt-8 mt-0">Slide to compare before and after holistic acne treatment</span>
                </div>
            </div>
