    ...
    return (
        <>
            <Banner
                ...
                image={<StaticImage alt="Essence of Beauty Ottawa - Vitamin A Infusion Peel" src="../assets/images/skinRemodelingHeader.jpg" />}
            />
            <section className="flex flex-col md:flex-row md:items-center p-4 md:p-4 my-8" aria-labelledby="vitamin-a-peel-heading">
                <div className="flex flex-col lg:my-8 md:w-1/2 mx-auto">
                    <h1 id="vitamin-a-peel-heading" className="text-2xl md:text-4xl font-bold mb-2">Vitamin A Infusion Peel For Acne, Rosacea & More</h1>
                ...
                <StaticImage
                    loading="eager"
                    src="../assets/images/vitamin-a-infusion-peel.jpg"
            ...
            <section id="vitamimn-a-skin-remodeling-info" className="flex flex-col lg:m-8 p-4 lg:p-8 bg-lightGreen rounded-sm shadow-lg" aria-labelledby="peel-info-heading">
            ...
            <section className="p-4 lg:p-8 mt-16 mb-8" aria-labelledby="advantages-heading">
                ...
                <div className='mt-8 mb-4 px-4 py-4'>
                <strong>Price per treatment: </strong>$235
                </div>
            </section>
    ...
    return (
        <>
            <Seo
                ...
                pageImage="https://www.essenceofbeauty.ca/images/vitamin-a-infusion-peel.jpg"
            />
