                                ...
                                <div className="flex flex-col lg:px-4">
                                    ...
                                    <span>
                                        <strong className="mr-2 text-brown">
                                            Advanced Add-ons available with Radiance Hydro Infusion Facial
                                        </strong>
                                    </span>
                                    <Button
                                        data={{ text: "Learn More", link: "/radiance-hydro-infusion-facial/" }}
...
export const Head = () => {
    return (
        <>
            <Seo
                pageTitle="Aging & Dehydrated Skin - Facial Rejuvenation Treatment Ottawa"
