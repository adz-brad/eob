    ...
    <>
        ...
        <div className="flex flex-col md:flex-row md:items-center p-4 md:p-8 my-8">
            <div className="flex flex-col md:w-1/2 mx-auto">
                <h1 className="text-2xl md:text-4xl font-bold mb-2">Enhance The Natural Beauty of Your Skin With Peeling!</h1>
                <h2 className="text-xl md:text-2xl mt-2 mb-4 subheader">Treat yourself to a reinvigorating Vegan Facial Peel designed to effectively treat acne scars, blemishes, sun damage & signs of aging.</h2>
                <p className="my-1">
                Restorative Bio Peel is a new dimension of facial treatment & peeling offered by Essence of Beauty Ottawa which can be used as a replacement for laser therapy and exfoliating acid. It has exceptional curative properties for every skin type. Stimulate the body’s scar-healing response and increase skin cell renewal. The creation of collagen and elastin is initiated as your skin heals, giving you an almost instant plumping effect. It also aids in the treatment of scars, acne, dark marks, sun exposure, and skin aging. 
                </p>
                <Button
        ...
        <div id="restorative-bio-peel-info" className="flex flex-col m-4 p-4 lg:p-8 lg:m-8 bg-lightGreen rounded-sm shadow-md">
                <div className="lg:p-8">
                    <h2 className="text-2xl md:text-4xl mb-4">How Does The Restorative Bio Peel Work?</h2>
                    <p className="my-1">
                ...
                <h2 className="text-2xl md:text-4xl mb-2">The Benefits</h2>
                <h3 className="text-base md:text-xl mb-4 font-bold text-brown">The Main Benefits of Restorative Bio Peel:</h3>
        ...
        <div className="md:p-8">
                <Card cardBodyClass="p-4 md:p-8">
                    ...
                    <div className="flex flex-col my-4">
                        <h3 className="text-base md:text-xl font-bold mb-2 text-brown">Revitalizing Bio Peel</h3>
                        <p className="my-1">
