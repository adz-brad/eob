            ...
            <>
              <div id="testimonialWrapper" className="relative flex flex-grow items-center justify-center overflow-hidden">
                ...
                { testimonials.map((testimonial, i) => {   
                  ...
                  return(
                    <div key={i} className="flex flex-col items-center absolute top-1/2 left-1/2 transform -translate-x-1/2 transition-all p-2 md:p-0" style={style} role="group" aria-label={`Testimonial ${i + 1} of ${testimonials.length}`} aria-hidden={active !== i}>
              ...
              <div className="flex flex-row items-center absolute bottom-1 left-1/2 transform -translate-x-1/2" role="group" aria-label="Testimonial navigation">
                { testimonials.map((testimonial, i) => {
                  return(
                    <button 
                      key={i}
