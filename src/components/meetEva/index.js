...
const MeetEva = ({ _key }) => {
    return (
        <div key={_key} className="pt-20 pb-10 md:py-20 px-4 md:px-12 flex flex-col lg:flex-row">
            <StaticImage loading="lazy" src="https://github.com/brad-adrenalize/eob/blob/main/src/assets/images/meet-eva.png?raw=true" className="w-full lg:w-2/5 rounded-sm shadow-md" alt="Essence of Beauty - Meet Eva" />
